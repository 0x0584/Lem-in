...
/*   Updated: 2020/12/12 14:25:53 by archid-          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool edges_share_vertex(t_graph g, t_edge e, t_edge o) {
    return (e->src == o->src && e->src != g->source) ||
           (e->dst == o->dst && e->dst != g->sink);
}

static bool path_is_correct(t_graph g, t_lst path_a, t_lst path_b) {
    t_lstnode walk_a;
    t_lstnode walk_b;
